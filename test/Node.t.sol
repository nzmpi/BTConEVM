...
contract TestNode is BaseTest {
    ...
    function test_validateTx_P2PKH() public {
        ...
        TxInput[] memory inputs = new TxInput[](1);
        inputs[0] = TxInput({
            txId: 0xffb7105241405f30849cfa7d3be277d5f4da62c4f45d96df26116fecae4e6ceb,
            vout: bytes4(uint32(3)),
            scriptSig: hex"4830450221009860646b4f663628853ec357b8d364b75e6c1cdf6138471fa74ada8c86edeb2502201a6c6728241c04abfedd62b6e497edcb39a6b01061fc54c5f3f115398704d280012102108c91bbb9473d6b8a1f14cc99a8f34ba361f73fbfac3b8a660c6c4d654a4129",
            sequence: hex"ffffffff"
        });

        TxOutput[] memory outputs = new TxOutput[](1);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(0)),
            scriptPubKey: hex"6a245336ba7c125fd0e2bf432f2379eb849d6906c4adb9e1713ff2058c76c12ef50e1e07ac75"
        });
        ...
        inputs[0] = TxInput({
            txId: 0x162221aa810d22a9d085295932668d3b683cec3631d672d4419788855ecb7f93,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[1] = TxInput({
            txId: 0xd8c6a0879264cef0aecaf16e5ca7714ca072c0c47c01179e17fbaf15c1183ab2,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[2] = TxInput({
            txId: 0xee494cdaeeee5257518ed7da8e1169ee865f9919bd5a40296971e9ea99d63671,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[3] = TxInput({
            txId: 0xc982385ba9f9cd0a0b14051efe878102adca46773b696095bbd0cd7ad2396d0f,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[4] = TxInput({
            txId: 0x40bf2b3611b864996f406b52f320901b2d0e1d5fc83c3b701bf81150c3039c99,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });

        outputs = new TxOutput[](2);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(19836425)),
            scriptPubKey: hex"76a91438389756a60900dadb47590bcade162452dc0b5888ac"
        });
        outputs[1] = TxOutput({
            amount: bytes8(uint64(39708114)),
            scriptPubKey: hex"76a914f8678d7aad9730afe575e4a8e51abfd44a510b8088ac"
        });
    ...
    function test_validateTx_P2SH() public {
        ...
        TxInput[] memory inputs = new TxInput[](1);
        inputs[0] = TxInput({
            txId: 0xb5336475543fb8ffc95783eab71c3eb7153b99f12966fbf42662509b3839adc7,
            vout: bytes4(uint32(5)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });

        TxOutput[] memory outputs = new TxOutput[](1);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(35560)),
            scriptPubKey: hex"76a914b1df5abd0a71b36e02a8bde3a14b2f9083f8c9fd88ac"
        });
        ...
        inputs[0] = TxInput({
            txId: 0xf8f4cfb56430806ef86aea4bf2f19b289793e2c343d69277786537b33bee5b9d,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[1] = TxInput({
            txId: 0x39863ea2c38943c0a64c79677056cf4d713083588fee568d0f4f926ec072ee17,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });
        inputs[2] = TxInput({
            txId: 0x5691e3f696dfb4c5fe052119590265ce5b24949cf811100253dd7e8fb93aee8b,
            vout: bytes4(uint32(1)),
            scriptSig: hex"",
            sequence: hex"ffffffff"
        });

        outputs = new TxOutput[](2);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(2991287)),
            scriptPubKey: hex"76a914b2a876a1b1099c2d4f7fa23056c1e8f4dfd1a67088ac"
        });
        outputs[1] = TxOutput({
            amount: bytes8(uint64(182453783)),
            scriptPubKey: hex"a9140fda2d6bce7644a53bfd80c49c14286df1fa376a87"
        });
    ...
    function test_validateTx_P2WPKH() public {
        ...
        inputs[0] = TxInput({
            txId: 0xb7823a744abd0aafe6792557bce8254b6c487a80f844181f8b9bdb93c62a3d45,
            vout: bytes4(0),
            scriptSig: "",
            sequence: 0xffffffff
        });
        inputs[1] = TxInput({
            txId: 0xd73e4018e72fcdf3f46ced8e044b970d89e4853ce65f135f11230ddbeda6184b,
            vout: bytes4(uint32(49)),
            scriptSig: "",
            sequence: 0xffffffff
        });
        ...
        TxOutput[] memory outputs = new TxOutput[](1);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(781059)),
            scriptPubKey: hex"76a914297b00828947f06bbe4015d8d227df0b7bc7de4788ac"
        });
        ...
        inputs = new TxInput[](3);
        inputs[0] = TxInput({
            txId: 0x7b011fa1ef2ecfbc6009f8979e28e1774deec9f051708cf6d54d5dbff564e9f5,
            vout: bytes4(uint32(1)),
            scriptSig: "",
            sequence: 0xfffffffe
        });
        inputs[1] = TxInput({
            txId: 0x0001cd7297c1105755fbce1dc4a2a71fcbec16e18c762d0d62097b7558ca7386,
            vout: bytes4(uint32(1)),
            scriptSig: "",
            sequence: 0xfffffffc
        });
        inputs[2] = TxInput({
            txId: 0x75c5d6cb8f578e4d210e453a5c3ede1b41d48a3e3b04afb2e5e15845be07f39f,
            vout: bytes4(uint32(4)),
            scriptSig: "",
            sequence: 0xfffffffb
        });
        ...
        outputs = new TxOutput[](2);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(1340000)),
            scriptPubKey: hex"a9149eb8a0684b0884822d89a701d0274b460d42023787"
        });
        outputs[1] =
            TxOutput({amount: bytes8(uint64(1126)), scriptPubKey: hex"0014d0e05a33dd8023493d212cf670269b0a27302620"});
    ...
    function test_validateTx_P2WSH() public {
        ...
        TxInput[] memory inputs = new TxInput[](1);
        inputs[0] = TxInput({
            txId: 0xbd430d52f35166a7dd6251c73a48559ad8b5f41b6c5bc4a6c4c1a3e3702f4287,
            vout: bytes4(0),
            scriptSig: "",
            sequence: 0xffffffff
        });
        ...
        TxOutput[] memory outputs = new TxOutput[](1);
        outputs[0] =
            TxOutput({amount: bytes8(uint64(73182)), scriptPubKey: hex"00145d6f02f47dc6c57093df246e3742cfe1e22ab410"});
        ...
        inputs[0] = TxInput({
            txId: 0x2fff4c03393b3862944cabf856554a3432b776c15a891edec9058fbe814650a9,
            vout: bytes4(uint32(5)),
            scriptSig: "",
            sequence: 0xffffffff
        });
        ...
        outputs = new TxOutput[](2);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(9400000)),
            scriptPubKey: hex"76a914609c5a63404058e84050589b0d42596df6227f9a88ac"
        });
        outputs[1] = TxOutput({
            amount: bytes8(uint64(2529460)),
            scriptPubKey: hex"0020701a8d401c84fb13e6baf169d59684e17abd9fa216c8cc5b9fc63d622ff8c58d"
        });
    ...
    function test_validateTx_mixed() public {
        ...
        TxInput[] memory inputs = new TxInput[](2);
        inputs[0] = TxInput({
            txId: 0xbfd9c92cde92d9cb27bb2a91ccdf8d1507152541b26c4e4ad238014ade7c330c,
            vout: bytes4(0),
            scriptSig: hex"",
            sequence: 0xffffffff
        });
        inputs[1] = TxInput({
            txId: 0x6f67eabf9220d9af0275db0dd2e0398249d1be7a6e15051f3bb648eb823f8727,
            vout: bytes4(uint32(2)),
            scriptSig: hex"47304402205f24da490d89a31b753a8b3e7b24c0d3b0f9124552e666d8578e8dd3fe029ae40220479f932d1ea955eafd658bff3878e7354d5e6c154d688aa043bfcb2c7cb8aad601210207d344596cc0883990b0137c0a7534920211278948a64397a9cf1584a8484f97",
            sequence: 0xffffffff
        });

        TxOutput[] memory outputs = new TxOutput[](3);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(98522146)),
            scriptPubKey: hex"a9141199b83ec2069d16bd075f9b43f4e4cfedc4f09787"
        });
        outputs[1] = TxOutput({
            amount: bytes8(uint64(7906847)),
            scriptPubKey: hex"a91470d6baffab240bece5d74698dadc39b7649b3a2887"
        });
        outputs[2] = TxOutput({
            amount: bytes8(uint64(122747)),
            scriptPubKey: hex"76a914becac737c973aab0e5530c611b9ac39b582d38c288ac"
        });
    ...
    function test_invalid_validateTx() public {
        ...
        inputs = new TxInput[](1);
        inputs[0] = TxInput({
            txId: 0x9cb5776171e603028725f0b6ae4211593cd36507295a5c403c72179f0f4d6e84,
            vout: bytes4(uint32(1)),
            scriptSig: hex"483045022100f808708a72d92e42647bd7c801d437bf82a29dd1880457c6e0967240f40089e0022034af63b6d3693d97bdf739aa967b8977127a48caca7389927029864eab9cd69d012102c9fb474d76a1f24abc3ff138acac75d5074e397841305e899540069ff044f00c",
            sequence: hex"ffffffff"
        });

        outputs = new TxOutput[](2);
        outputs[0] = TxOutput({
            amount: bytes8(uint64(15564202)),
            scriptPubKey: hex"76a914069532d8fec3199b205d1269a3eac85bf55c2fde88ac"
        });
        outputs[1] = TxOutput({
            amount: bytes8(uint64(748138)),
            scriptPubKey: hex"76a914ab4aaa0207f7f87db339fdcec70dc82f257bdb4888ac"
        });
    ...
    function _addPrevTx(bytes32 _txId, bytes4 _vout, uint64 _amount, bytes memory _scriptPubKey) internal {
        ...
        outputs[uint32(_vout)] = TxOutput({amount: bytes8(_amount), scriptPubKey: _scriptPubKey});
